...
-- Volcando estructura para tabla busqueda.documento
use `busqueda`;
...
-- Volcando estructura para tabla busqueda.termino
...
CREATE TABLE IF NOT EXISTS `termino` (
  ...
  PRIMARY KEY (`idword`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla busqueda.terminoxdocumento
DROP TABLE IF EXISTS `terminoxdocumento`;
CREATE TABLE IF NOT EXISTS `terminoxdocumento` (
  `idtxd` int(11) NOT NULL AUTO_INCREMENT,
